...
Declare Function ModPlug_Create Lib "npmod32" (ByVal argc As Long, ByVal argn As String, ByVal argv As String) As Long
Declare Function ModPlug_CreateEx Lib "npmod32" (ByVal lpszArgs As String) As Long
Declare Function ModPlug_Destroy Lib "npmod32" (ByVal plugin As Long) As Long
Declare Function ModPlug_GetCurrentPosition Lib "npmod32" (ByVal plugin As Long) As Long
Declare Function ModPlug_GetMaxPosition Lib "npmod32" (ByVal plugin As Long) As Long
Declare Function ModPlug_GetSongLength Lib "npmod32" (ByVal plugin As Long) As Long
Declare Function ModPlug_GetVersion Lib "npmod32" () As Long
Declare Function ModPlug_GetVolume Lib "npmod32" (ByVal plugin As Long) As Long
Declare Function ModPlug_IsPlaying Lib "npmod32" (ByVal plugin As Long) As Long
Declare Function ModPlug_IsReady Lib "npmod32" (ByVal plugin As Long) As Long
Declare Function ModPlug_Load Lib "npmod32" (ByVal plugin As Long, ByVal lpszFileName As String) As Long
Declare Function ModPlug_Play Lib "npmod32" (ByVal plugin As Long) As Long
Declare Function ModPlug_SetCurrentPosition Lib "npmod32" (ByVal plugin As Long, ByVal nPos As Long) As Long
Declare Function ModPlug_SetVolume Lib "npmod32" (ByVal plugin As Long, ByVal nVol As Long) As Long
Declare Function ModPlug_SetWindow Lib "npmod32" (ByVal plugin As Long, ByVal hWnd As Long) As Long
Declare Function ModPlug_Stop Lib "npmod32" (ByVal plugin As Long) As Long

ModPlugin mixer flags:
Const MPMIX_STEREO = &H1&
Const MPMIX_16BIT = &H2&
Const MPMIX_DISABLE_OVERSAMPLING = &H10&
Const MPMIX_BASS_EXPANSION = &H20&
Const MPMIX_DOLBY_SURROUND = &H8&
Const MPMIX_DISABLE_AUTOPLAY = &H40&
...
================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : MODPlayer Project Overview
===============================================================================

The application wizard has created this MODPlayer application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your MODPlayer application.
...
MODPlayer.h
    ...
    CMODPlayerApp application class.
...
res\MODPlayer.ico
    ...
    icon is included by the main resource file MODPlayer.rc.
...
MODPlayerDlg.h, MODPlayerDlg.cpp - the dialog
    These files contain your CMODPlayerDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in MODPlayer.rc, which can be edited in Microsoft Visual C++.
...
StdAfx.h, StdAfx.cpp
    ...
    named MODPlayer.pch and a precompiled types file named StdAfx.obj.
